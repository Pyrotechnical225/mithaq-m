...
export const Route = createFileRoute("/community")({
  head: () => ({
    meta: [
      { title: "Muslim Marriage in Your Community | MeetHaq" },
      {
        name: "description",
        content:
          "Finding a practicing Muslim spouse locally — how community, masjid networks, and MeetHaq work together to keep the search halal.",
      },
      { property: "og:title", content: "Muslim Marriage in Your Community" },
      {
        property: "og:description",
        content: "Finding a practicing Muslim spouse locally — community, masjids, and MeetHaq.",
      },
    ],
  }),
    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          ...
          family networks, and platforms like MeetHaq each play a role in a halal search.
        </p>
        ...
        <section className="mt-10 space-y-6">
          ...
          <ul className="list-disc space-y-2 pl-6 text-muted-foreground">
            ...
            <li>
              <strong className="text-foreground">Platforms like MeetHaq:</strong> Reach practicing
        ...
        <section className="mt-10 space-y-4">
          ...
          <p className="text-muted-foreground">
            Whether you meet through a masjid dinner or a match on MeetHaq, the same principles
