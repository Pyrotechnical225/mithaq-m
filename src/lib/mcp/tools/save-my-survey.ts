...
export default defineTool({
  ...
  description:
    "Upsert the signed-in user's MeetHaq survey answers. Answers is a map of question id (string) to answer text. Set completed=true only after all required questions (1-30) are filled.",
  inputSchema: {
